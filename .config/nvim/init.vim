...
let g:vim_bootstrap_langs = "c,haskell,html,javascript,python,ruby,rust"
...
call s:source_rc('other_langs.vim')
call s:source_rc('python.rc.vim')
call s:source_rc('ruby.rc.vim')
call s:source_rc('rust.rc.vim')
